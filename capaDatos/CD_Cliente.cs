    ...
    public class CD_Cliente
    {
        ...
        public int Registrar(Cliente obj, out string Mensaje)
        {
            ...
            try
            {
                using (SqlConnection oconexion = new SqlConnection(Conexion.cn))
                {
                    ...
                    oconexion.Open();
                    cmd.ExecuteNonQuery();
                    idAutogerado = Convert.ToInt32(cmd.Parameters["Resultado"].Value);
        ...
        public List<Cliente> Listar()
        {
            ...
            try
            {
                using (SqlConnection oconexion = new SqlConnection(Conexion.cn))
                {
                    string query = "select IdCliente,Usuario, Nombre, Apellidos, Correo,  Clave, Reestablecer from CLIENTE ";
