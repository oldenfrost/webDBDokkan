...
namespace CapaPresentacionTienda.Controllers
{
    public class TiendaController : Controller
    {
        ...
        public JsonResult ListarProductos(int idcategoria)
        {
            ...
            }).Where(p => p.oCategoria.IdCategoria == (idcategoria == 0 ? p.oCategoria.IdCategoria : idcategoria) && p.Stock > 0 && p.Activo == true).ToList();
        ...
        public JsonResult ObtenerPais()
        {
            List<Pais> oLista = new List<Pais>();
            oLista = new CN_Ubicacion().ObtenerPais();
        ...
        public async Task<JsonResult> ProcesarPago(List<Carrito> oListaCarrito, Venta oVenta)
        {
            ...
            foreach (Carrito oCarrito in oListaCarrito)
            {
                ...
                oListaItem.Add(new Item()
                {
                    ...
                    {
                        currency_code = "USD",
                        value = oCarrito.oProducto.Precio.ToString("C", new CultureInfo("en-US")),
            }
                });
            ...
            PurchaseUnit purchaseUnit = new PurchaseUnit()
            {
                ...
                {
                    currency_code = "USD",
                    value = total.ToString("C", new CultureInfo("en-US")),
            ...
            Checkout_Order oCheckOutOrder = new Checkout_Order()
            {
                ...
                application_context = new ApplicationContext()
                {
                    ...
                    user_action="PAY_NOW",
                    return_url= "https://localhost:44304/Tienda/PagoEfectuado",
                    cancel_url= "https://localhost:44304/Tienda/Carrito"
                }
            };
